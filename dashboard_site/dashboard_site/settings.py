...
PROD = '/ubuntu/' in os.path.abspath('./')
...
# SECURITY WARNING: keep the securityret key used in production secret!
...
if PROD:
    STATICFILES_DIRS = []
    STATIC_ROOT = '/home/ubuntu/mev-frp-dashboard/dashboard_site/static'
